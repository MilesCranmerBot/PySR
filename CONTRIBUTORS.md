...
To get an overview of the project, read PySR's [README](README.md). The [PySR docs](https://pysr.ai/) give additional information.
...
check out the [guide](https://pysr.ai/backend/) on modifying a custom SymbolicRegression.jl library.
